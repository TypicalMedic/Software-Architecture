...
type GetMeetingsMeetingServiceResultBody struct {
	Meetings []MeetingService `json:"meetings"`
}

type GetMeetingMeetingServiceResultBody struct {
	Meeting MeetingService `json:"meeting"`
}
...
type Meeting struct {
	...
	Description        string    `json:"description"`
	MeetingTime        time.Time `json:"meeting_time"`
	StudentParticipant Student   `json:"student_participant"`
	IsOnline           bool      `json:"is_online"`
}
